...
select_region = ['LA_L', 'LA_R', 'LO_L', 'LO_R', 'ME_L', 'ME_R']

df1 = pd.read_csv('proj_test_copy.csv', dtype={0: str})
...
df1.to_csv('merged_ccf.csv', index=False) 
...
df_unipolar.to_csv('filter_data/proj_unipolar.csv', index=False)  
df_bipolar.to_csv('filter_data/proj_bipolar.csv', index=False)
df_multipolar.to_csv('filter_data/proj_multipolar.csv', index=False)
